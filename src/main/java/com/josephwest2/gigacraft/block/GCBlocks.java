...
public class GCBlocks {
    ...
    public static final DeferredItem<BlockItem> BISMUTH_BLOCK_ITEM = GCItems.ITEMS
            .registerSimpleBlockItem(BISMUTH_BLOCK);

    public static final DeferredBlock<Block> BISMUTH_ORE = BLOCKS.register("bismuth_ore",
            () -> new DropExperienceBlock(UniformInt.of(2, 4),
                    BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()));

    public static final DeferredItem<BlockItem> BISMUTH_ORE_ITEM = GCItems.ITEMS.registerSimpleBlockItem(BISMUTH_ORE);
